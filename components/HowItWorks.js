...
const DashedChevron = ({ direction = "down", size = 260, color = "#3B82F6" }) => {
  // Choose points based on direction
  const points =
    direction === "up"
      ? "1,7 12,1 23,7" // ∧ shape
      : "1,1 12,7 23,1"; // V shape
    ...
    <section>
      ...
      <div className="flex items-end justify-around mt-[70px]">
        ...
        <div className="flex flex-col items-center gap-[25px]">
            <p className="font-[700] text-[64px] text-[#B9C8F3] flex absolute -bottom-40 -left-[-20px]">1</p>
        ...
        {/* Down arrow between step 1 and 2 */}
        ...
        {/* Step 2 */}
        <div className="flex flex-col items-center gap-[25px]">
             <p className="font-[700] text-[64px] text-[#B9C8F3] flex absolute -bottom-80 -right-[-830px]">2</p>
          <div className="border-[4px] w-[240px] h-[240px] text-[#B9C8F3] border-dashed rounded-[50%] flex items-center justify-center">
            <div className="w-[120px] h-[120px] bg-[#EBF3FE] flex items-center justify-center rounded-[50%]">
        ...
        {/* Up arrow between step 2 and 3 */}
        {/* <DashedChevron direction="up" /> */}
        ...
        {/* Step 3 */}
        <div className="flex flex-col items-center gap-[25px]">
             <p className="font-[700] text-[64px] text-[#B9C8F3] flex absolute -bottom-98 -right-[-300px]">3</p>
          <div className="border-[4px] w-[240px] h-[240px] text-[#B9C8F3] border-dashed rounded-[50%] flex items-center justify-center">
            <div className="w-[120px] h-[120px] bg-[#EBF3FE] flex items-center justify-center rounded-[50%]">
