...
<div className="w-[80px] sm:w-[100px] h-[6px] sm:h-[8px] bg-blue-600 opacity-100 rounded-[8px] mx-auto"></div>
  ...
  className="w-full max-w-xl sm:max-w-xl lg:max-w-2xl xl:max-w-4xl h-auto"
/>
          ...
          <div className="space-y-6 lg:space-y-8 order-1 lg:order-2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
              <div className="bg-white shadow-lg hover:shadow-xl transition-shadow duration-300 w-full max-w-sm mx-auto sm:max-w-none sm:mx-0" style={{ minHeight: '280px', borderRadius: '20px', opacity: 1, padding: '24px' }}>
                <div className="bg-blue-100 rounded-full flex items-center justify-center mb-4 sm:mb-6 mx-auto" style={{ width: '60px', height: '60px', opacity: 1, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                  <svg className="w-6 h-6 sm:w-8 sm:h-8 text-[#153799] flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
